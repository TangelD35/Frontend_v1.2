...
import {
    ...
    Mail, Lock, User, Phone, Building, Check, Shield,
                    ...
                    <div className="w-full max-w-2xl relative z-10">
                        ...
                        <div className="text-center mb-10">
                            <div className="inline-flex items-center justify-center mb-6">
                                <div className="relative h-28 w-28 rounded-full bg-gradient-to-br from-[#CE1126] via-white to-[#002D62] p-[3px] shadow-2xl shadow-[#CE1126]/60">
                                    <div className="h-full w-full rounded-full overflow-hidden bg-slate-900 flex items-center justify-center p-2">
                                        <img
                        ...
                        {/* Formulario centrado */}
                        <div className="w-full overflow-hidden rounded-3xl border border-white/20 bg-slate-900/60 backdrop-blur-2xl shadow-2xl shadow-black/40">
                            <div className="border-b border-white/10 bg-gradient-to-r from-[#CE1126]/5 via-transparent to-[#002D62]/5 px-6 py-8 sm:px-10 sm:py-10 backdrop-blur-sm">
                                <div className="flex items-center justify-between gap-4 sm:gap-6">
                                    <div className="flex-1">
                                        <div className="inline-flex items-center gap-2 rounded-full border border-[#CE1126]/30 bg-gradient-to-r from-[#CE1126]/10 to-[#002D62]/10 px-4 py-2 text-xs font-bold text-white/90 backdrop-blur-sm mb-5">
                                        ...
                                        <p className="text-sm text-white/70 sm:text-base font-medium leading-relaxed">
                                            Únete a la plataforma oficial de análisis táctico de la Selección Nacional
                                        </p>
                                    </div>
                                    <div className="hidden sm:flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-[#CE1126] via-[#CE1126]/90 to-[#002D62] text-white shadow-xl shadow-[#CE1126]/30">
                                        <UserPlus className="h-10 w-10" />
                                    </div>
                                </div>
                            </div>
                            <form onSubmit={handleSubmit} className="space-y-6 px-6 py-8 text-slate-900 sm:px-10 sm:py-10">
                                {/* Error del servidor */}
                                {error && (
                                    <div className="flex items-center gap-3 rounded-2xl border border-red-400/30 bg-red-500/10 backdrop-blur-sm px-5 py-4 text-sm text-red-100 shadow-lg">
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-5">
                                        <div className="flex flex-col gap-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 text-white shadow-lg">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className="text-xs uppercase tracking-[0.3em] text-white/50 font-bold mb-2">Paso {currentStep + 1} de {steps.length}</p>
                                                    <h3 className="text-xl font-bold text-white mb-1">{steps[currentStep].title}</h3>
                                                    <p className="text-sm text-white/70 font-medium">{steps[currentStep].description}</p>
                                                </div>
                                ...
                                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between pt-2">
                                    <div className="text-xs text-white/60 font-medium">{stepHelperText[steps[currentStep].id]}</div>
                                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                                        {currentStep > 0 && (
                                            <button
                                                type="button"
                                                onClick={handleBack}
                                                className="flex items-center justify-center gap-2 rounded-2xl border border-white/20 bg-white/5 backdrop-blur-sm px-6 py-3.5 text-sm font-bold text-white transition-all duration-200 hover:border-white/30 hover:bg-white/10 hover:scale-105 active:scale-95"
                                            >
                                                Volver
                                            </button>
                                        )}
                                        ...
                                        {!isLastStep && (
                                            <button
                                                type="button"
                                                onClick={handleNext}
                                                className="flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-[#CE1126] via-red-600 to-[#002D62] px-8 py-3.5 text-sm font-bold text-white shadow-xl shadow-[#CE1126]/40 transition-all duration-200 hover:shadow-2xl hover:shadow-[#CE1126]/60 hover:scale-105 active:scale-95"
                                            >
                                                Continuar
                                        ...
                                        {isLastStep && (
                                            <button
                                                ...
                                                className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-[#CE1126] via-red-600 to-[#002D62] px-8 py-4 text-base font-bold text-white shadow-xl shadow-[#CE1126]/40 transition-all duration-200 hover:shadow-2xl hover:shadow-[#CE1126]/60 hover:scale-105 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100 disabled:hover:shadow-xl"
                                            >
                            ...
                            {/* Link a login */}
                            <div className="text-center text-sm text-white/70 px-6 pb-8 sm:px-10">
                                ¿Ya tienes cuenta?{' '}
                                <Link
                                    to="/login"
                            ...
                            {/* Footer */}
                            <div className="border-t border-white/10 bg-gradient-to-r from-[#CE1126]/5 via-transparent to-[#002D62]/5 px-6 py-6 backdrop-blur-sm sm:px-10">
